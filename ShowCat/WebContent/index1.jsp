...
<div  align="center">
	...
	<div style="margin-left: 380px;" id="main">
		<div id="tabhead" class="tab-head">
			<h2 id="tab1" style="font-size: 18px;" class="selected" name="tab">付 款</h2>
			<h2 id="tab2" style="font-size: 18px;" name="tab">交 易 查 询</h2>
			<h2 id="tab3"  style="font-size: 18px;"name="tab">退 款</h2>
			<h2 id="tab4"  style="font-size: 18px;"name="tab">退 款 查 询</h2>
			<h2 id="tab5" style="font-size: 18px;" name="tab">交 易 关 闭</h2>
		</div>
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input name="WIDsubject" value="租号玩"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" readonly="readonly" value="${money1}" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;margin-left:-550px">付 款</button>
			...
			<div id="body2" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;margin-left:-550px">交 易 查 询</button>
			...
			<div id="body3" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;margin-left:-550px">退 款</button>
			...
			<div id="body4" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;margin-left:-550px">退 款 查 询</button>
			...
			<div id="body5" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;margin-left:-550px">交 易 关 闭</button>
